  ...
  <React.Fragment>
    ...
    <Parallax pages={5}>
      ...
      <Content speed={0.4} offset={0}>
        <Hero>
          <BigTitle>
            Hi, <br /> I'm Avik Nandy.
          </BigTitle>
          <Subtitle>I love learning, creating, and distributing web experiences for the next generation of users.</Subtitle>
        </Hero>
      </Content>
      <DividerMiddle
      ...
      <Content speed={0.4} offset={1.2} factor={2}>
        <Inner>
          ...
          <ProjectsWrapper>
            <ProjectCard
              title="Davidson Architects"
              link="http://davidsonarchitects.com"
              bg="linear-gradient(to right, #D4145A 0%, #FBB03B 100%)"
            >
              A responsive brochure site for Davidson Architects, written using Jquery, Bootstrap 3, HTML5, and CSS3.
            </ProjectCard>
            <ProjectCard
              title="Earth Pledge"
              link="http://earthpledge.org"
              bg="linear-gradient(to right, #662D8C 0%, #ED1E79 100%)"
            >
              A responsive brochure site for The Earth Pledge, written using Jquery, Bootstrap 3, HTML5, and CSS3.
            </ProjectCard>
            <ProjectCard
              title="Edge Education"
              link="https://edgeed.com/"
              bg="linear-gradient(to right, #009245 0%, #FCEE21 100%)"
            >
              Edge Education: A study preparation service based out of Springfield, VA. Built using Drupal 7 and Drupal Commerce.
            </ProjectCard>
            <ProjectCard
              title="Cultural Treasures"
              link="http://culturaltreasures.org/"
              bg="linear-gradient(to right, #D585FF 0%, #00FFEE 100%)"
            >
              A responsive brochure site for The Cultural Treasures Foundation, based in DC. Written using Jquery, Bootstrap 3, HTML5, and CSS3.
            </ProjectCard>
          </ProjectsWrapper>
        </Inner>
      </Content>
      ...
      <Content speed={0.4} offset={4}>
        <Inner>
          ...
          <ContactText>
            ...
            <a href="https://twitter.com/av1k">Twitter</a> &{' '}
            <a href="https://www.instagram.com/av1k/">Instagram</a>
          </ContactText>
        </Inner>
        <Footer>
          &copy; 2018 • Harbinger Industries.{' '}
